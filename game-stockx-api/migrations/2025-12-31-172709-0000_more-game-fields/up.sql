...
ALTER TABLE products ADD COLUMN IF NOT EXISTS total_rating DOUBLE PRECISION NULL DEFAULT NULL;
ALTER TABLE products ADD COLUMN IF NOT EXISTS game_type INTEGER NULL DEFAULT NULL;
ALTER TABLE products ADD COLUMN IF NOT EXISTS parent_game INTEGER REFERENCES products(id) ON DELETE CASCADE NULL DEFAULT NULL;